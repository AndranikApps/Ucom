...
function edit(ctx) {
    ...
    childs[6].innerHTML = '<input id="isDeleted" type="checkbox" value="' + !!childs[6].innerText + '" ' + (!!childs[6].innerText ? 'checked' : '') + ' />';
...
function save(ctx) {
    ...
    formData.append("isDeleted", childs[6].childNodes[0].value == "on");
